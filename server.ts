...
function createSeedDemoListings(): Listing[] {
  return [
    ...
    },
    {
      ...
      is_persistent: false,
      expires_at: null,
      image_url: "https://images.unsplash.com/photo-1527842891421-42eec6e703ea?auto=format&fit=crop&w=800&q=80",
      image_attribution: "Unsplash (Sugarcane Crop Photography)",
      source_type: "Example Demo Produce",
